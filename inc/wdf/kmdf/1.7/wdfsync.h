...
(*PFN_WDFOBJECTACQUIRELOCK)(
    ...
    __in
    __drv_neverHoldGlobal(WdfObjectLock, Object)
    __drv_acquiresResourceGlobal(WdfObjectLock, Object)
    WDFOBJECT Object
    );
...
(*PFN_WDFOBJECTRELEASELOCK)(
    ...
    PWDF_DRIVER_GLOBALS DriverGlobals,
    __in
    __drv_mustHoldGlobal(WdfObjectLock, Object)
    __drv_releasesResourceGlobal(WdfObjectLock, Object)
    WDFOBJECT Object
    );
